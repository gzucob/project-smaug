...
def _to_row(analysis: TickerAnalysis) -> TickerAnalysisRow:
    ...
    return TickerAnalysisRow(
        ...
        payout_declared=i.payout_declared,
        dividend_yield_declared=i.dividend_yield_declared,
        ...
        dividends_declared=i.dividends_declared,
...
def _to_entity(row: TickerAnalysisRow) -> TickerAnalysis:
    return TickerAnalysis(
        ...
        indicators=Indicators(
            ...
            payout_declared=row.payout_declared,
            dividend_yield_declared=row.dividend_yield_declared,
            ...
            dividends_declared=row.dividends_declared,
